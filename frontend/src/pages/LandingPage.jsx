...
function LandingPage() {
  ...
  const getImageUrl = (image) => {
    if (!image || typeof image !== "string") return "/default-product-image.png";
    if (image.startsWith("http")) return image;
    if (image.startsWith("/")) return `http://localhost:5000${image}`;
    return `http://localhost:5000/uploads/${image}`;
  };
  ...
  return (
    <div className="landing-container">
        ...
        {loading ? (
          ...
          <div className="products-grid">
            {featuredProducts.map((product) => {
              ...
              const productId = _id.split?.("-")[0] || _id;
              const avg =
                ratings.length > 0
                ...
                <div key={_id} className="product-card">
                  <div className="product-image">
                    ...
                    <span className={`product-category ${category}`}>
                      ...
                      {category === "pet" ? "Pet" : "Livestock"}
                    </span>
                    <div className="product-overlay">
                      <Link to={`/product/${productId}`} className="quick-view">
                        <FiEye className="quick-view-icon" />
                        Quick View
                      </Link>
                    </div>
                  ...
                  <div className="product-details">
                    ...
                    {isOption && quantityOption && (
                      <div className="product-option">
                        <div className="option-left">
                          <span className="option-label">
                            {quantityOption.label || "Option"}
                          </span>
                          <span className="option-stock">
                            ({quantityOption.stock || 0} in stock)
                          </span>
                        </div>
                        <span className="option-price">
                          ₹{(quantityOption.price || 0).toFixed(2)}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="rating">
                      ...
                      {hasHalfStar && (
                        <FaStarHalf key="half" className="star-icon half-star" />
                      )}
                      {[...Array(emptyStars)].map((_, i) => (
                        <FiStar
                          key={`empty-${i}`}
                      ...
                      <span className="rating-value">{avg.toFixed(1)}</span>
                      <span className="reviews">({ratings.length} reviews)</span>
                    </div>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <h3>Easy Shopping</h3>
            <p>Browse thousands of products with intuitive filters and search functionality.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <FiTruck size={32} />
            ...
            <h3>Fast Delivery</h3>
            <p>Get your orders delivered quickly with our reliable logistics partners.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <FiShield size={32} />
      ...
      <footer className="footer">
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Animal Food Marketplace. All rights reserved.</p>
          <div className="payment-methods">
            <i className="fab fa-cc-visa"></i>
            <i className="fab fa-cc-mastercard"></i>
            <i className="fab fa-cc-paypal"></i>
